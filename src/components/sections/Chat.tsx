  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-10">
      ...
      <section className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          <p className="text-sm text-gray-700">
            If you're offline and somebody messages you, we'll let you know via email. We won't email you
            if you're online.
          </p>
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm text-gray-700">
          Only members in the group you're in can message you. You choose what group users can message you
          from by turning your chat on/off below.
        </p>
